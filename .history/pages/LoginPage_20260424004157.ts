...
export class LoginPage{
    ...
    constructor(page:Page){
        this.page = page;
        this.eleUtil = new ElementUtil(page, 2000);
    ...
    async doLogin(email:string, password:string):Promise<string>{
        this.eleUtil.fill(this.emailId, email);
        this.eleUtil.fill(this.password,password);
        this.eleUtil.click(this.loginBtn, { force: true, timeout: 5000 });
